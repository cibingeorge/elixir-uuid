defmodule ExUUID do
  ...
  * `"urn:uuid:ef1b1a28-ee34-11e3-8813-14109ff1a304"`
  ...
  ```elixir
  iex> ExUUID.binary_to_string!(<<135, 13, 248, 232, 49, 7, 68, 135,
  ...
  * `"urn:uuid:ef1b1a28-ee34-11e3-8813-14109ff1a304"`
  ...
  iex> ExUUID.uuid1(:default)
  "cdfdaf44-ee35-11e3-846b-14109ff1a304"

  iex> ExUUID.uuid1(:hex)
  ...
  iex> ExUUID.uuid3(:dns, "my.domain.com", :default)
  "03bf0706-b7e9-33b8-aee5-c6142a816478"

  iex> ExUUID.uuid3(:dns, "my.domain.com", :hex)
  "03bf0706b7e933b8aee5c6142a816478"

  iex> ExUUID.uuid3(:dns, "my.domain.com", :urn)
  "urn:uuid:03bf0706-b7e9-33b8-aee5-c6142a816478"

  iex> ExUUID.uuid3("cdfdaf44-ee35-11e3-846b-14109ff1a304", "my.domain.com")
  ...
  iex> ExUUID.uuid5(:dns, "my.domain.com", :hex)
  "016c25fd70e056fe9d1a56e80fa20b82"

  iex> ExUUID.uuid5(:dns, "my.domain.com", :urn)
  "urn:uuid:016c25fd-70e0-56fe-9d1a-56e80fa20b82"

  iex> ExUUID.uuid5("fb49a0ec-d60c-4d20-9264-3b4cfe272106", "my.domain.com")
